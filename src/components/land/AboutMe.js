      ...
      <div className='container'>
        ...
        <div className='row'>
          <div className='col-lg-4 ms-auto'>
            <p className='lead'>
              Patrick is a Software Developer. He makes Software and websites
              solutions using javaScript and Python languages. Patrick also writes
              technical articles and tutorials.
            </p>
          </div>
          <div className='col-lg-4 me-auto'>
            <p className='lead'>
              Patrick has been a freelancer for the last 2 years and is looking to
